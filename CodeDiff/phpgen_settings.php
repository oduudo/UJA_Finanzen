...
{
    $result = array();
    $result[] = array('caption' => 'Aktien', 'short_caption' => 'Aktien', 'filename' => 'aktien.php', 'name' => 'aktien', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
