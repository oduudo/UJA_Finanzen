...
smarty_core_load_plugins(array('plugins' => array(array('block', 'style_block', 'editors/combo_box.tpl', 8, false),)), $this); ?>
...
"<?php if (( $this->_tpl_vars['ComboBox']->IsSelectedValue($this->_tpl_vars['Value']) )): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['Name']; ?>
    ...
    foreach ($_from as $this->_tpl_vars['Value'] => $this->_tpl_vars['Name']):
?>
            <?php if (( $this->_tpl_vars['ComboBox']->IsSelectedValue($this->_tpl_vars['Value']) )): ?>
                <span
                        data-editor="true"
                        data-editor-class="ComboBox"
                        data-field-name="<?php echo $this->_tpl_vars['ComboBox']->GetFieldName(); ?>
